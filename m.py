...
def save_to_excel(questions: List[Dict], filename: str):
    """Save questions to an Excel file."""
    logger.info(f"Saving questions to Excel: {filename}")
...
def main():
    ...
    try:
        ...
        questions = quiz_gen.process_pdf("C:/Users/LENOVO/Desktop/ml2/Testcase_2 (1).pdf")

        # Save the generated questions to an Excel file
        if questions:
            save_to_excel(questions, "generated_questions.xlsx")
        else:
